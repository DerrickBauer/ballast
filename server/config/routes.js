...
module.exports.routes = {
  ...
  'POST /project/:id/issues': 'ProjectController.createIssue',
  'GET /project/:id/issues' : 'ProjectController.getIssues',
  'POST /project' : 'ProjectController.create',
  'GET /project/:id' : 'ProjectController.get' //will most likely be removed in production...it's just here to get the security token of a project if you forget
  /*
